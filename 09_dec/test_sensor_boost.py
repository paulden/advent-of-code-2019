...
from sensor_boost import compute_intcode_sequence, parse_intcode_sequence
...
parametrized_data_test_relative_mode = [
...
@pytest.mark.parametrize('initial_state,expected_output', parametrized_data_test_relative_mode)
def test_compute_intcode_sequence_should_handle_relative_mode(initial_state, expected_output):
    final_state, output = compute_intcode_sequence(initial_state + [0] * 100000)
